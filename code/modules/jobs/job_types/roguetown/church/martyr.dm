	...
	if(current_holder)
		...
		switch(state)
			...
			if(STATE_MARTYRULT)	//This is ONLY accessed during the last 30 seconds of the shorter variant.
				...
				if(H.mind)
					H.mind.adjust_skillrank(/datum/skill/combat/wrestling, SKILL_LEVEL_LEGENDARY, FALSE)
					H.mind.adjust_skillrank(/datum/skill/combat/swords, SKILL_LEVEL_LEGENDARY, FALSE)
					H.mind.adjust_skillrank(/datum/skill/combat/unarmed, SKILL_LEVEL_LEGENDARY, FALSE)
					H.mind.adjust_skillrank(/datum/skill/misc/athletics, SKILL_LEVEL_LEGENDARY, FALSE)
