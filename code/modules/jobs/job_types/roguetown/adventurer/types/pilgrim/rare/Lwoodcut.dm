...
/datum/outfit/job/roguetown/adventurer/masterwoodcutter/pre_equip(mob/living/carbon/human/H)
	..()
	H.mind.adjust_skillrank(/datum/skill/combat/axes, SKILL_LEVEL_LEGENDARY, TRUE) // AXE MEN! GIVE ME SPLINTERS!
	...
	H.mind.adjust_skillrank(/datum/skill/labor/lumberjacking, SKILL_LEVEL_LEGENDARY, TRUE)
