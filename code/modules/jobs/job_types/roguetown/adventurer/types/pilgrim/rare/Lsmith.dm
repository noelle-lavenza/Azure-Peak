...
/datum/outfit/job/roguetown/adventurer/masterblacksmith/pre_equip(mob/living/carbon/human/H)
	...
	if(H.pronouns == HE_HIM)
		...
		if(H.mind)
			...
			H.mind.adjust_skillrank(/datum/skill/craft/masonry, SKILL_LEVEL_APPRENTICE, TRUE)
			H.mind.adjust_skillrank(/datum/skill/craft/carpentry, SKILL_LEVEL_APPRENTICE, TRUE)
			H.mind.adjust_skillrank(/datum/skill/craft/blacksmithing, SKILL_LEVEL_LEGENDARY, TRUE)
			H.mind.adjust_skillrank(/datum/skill/craft/armorsmithing, SKILL_LEVEL_LEGENDARY, TRUE)
			H.mind.adjust_skillrank(/datum/skill/craft/weaponsmithing, SKILL_LEVEL_LEGENDARY, TRUE)
