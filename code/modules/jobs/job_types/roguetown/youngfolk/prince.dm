...
/datum/outfit/job/roguetown/heir/aristocrat/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		H.mind.adjust_skillrank(/datum/skill/combat/crossbows, pick(SKILL_LEVEL_NONE,SKILL_LEVEL_NOVICE), TRUE)
		...
		H.mind.adjust_skillrank(/datum/skill/misc/athletics, pick(SKILL_LEVEL_NONE,SKILL_LEVEL_NOVICE), TRUE)
...
/datum/outfit/job/roguetown/heir/inbred/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		H.mind.adjust_skillrank(/datum/skill/combat/knives, SKILL_LEVEL_NOVICE, TRUE)
		H.mind.adjust_skillrank(/datum/skill/misc/swimming, SKILL_LEVEL_APPRENTICE, TRUE)
		H.mind.adjust_skillrank(/datum/skill/misc/climbing, pick(SKILL_LEVEL_NONE,SKILL_LEVEL_NONE,SKILL_LEVEL_NOVICE), TRUE)
		H.mind.adjust_skillrank(/datum/skill/misc/athletics, pick(SKILL_LEVEL_NONE,SKILL_LEVEL_NOVICE), TRUE)
		H.mind.adjust_skillrank(/datum/skill/misc/riding, SKILL_LEVEL_APPRENTICE, TRUE)
		H.mind.adjust_skillrank(/datum/skill/misc/reading, SKILL_LEVEL_JOURNEYMAN, TRUE)
		H.mind.adjust_skillrank(/datum/skill/craft/cooking, SKILL_LEVEL_NOVICE, TRUE)
