/datum/job/roguetown/bogguardsman
	...
	tutorial = "Typically a denizen of the sparsely populated Azure woods, you volunteered up with the wardens - a group who keep a vigil over the untamed wilds."
...
/datum/outfit/job/roguetown/bogguardsman/ranger/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		H.mind.adjust_skillrank(/datum/skill/combat/slings, SKILL_LEVEL_EXPERT, TRUE) 
...
/datum/outfit/job/roguetown/bogguardsman/forester/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		H.mind.adjust_skillrank(/datum/skill/combat/slings, SKILL_LEVEL_APPRENTICE, TRUE)
