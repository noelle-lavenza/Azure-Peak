...
/datum/outfit/job/roguetown/sergeant/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		H.mind.adjust_skillrank(/datum/skill/misc/athletics, SKILL_LEVEL_MASTER, TRUE)	// We are basically identical to a regular MAA, except having better athletics to help us manage our order usage better
		H.mind.adjust_skillrank(/datum/skill/misc/riding, SKILL_LEVEL_NOVICE, TRUE)
		H.mind.adjust_skillrank(/datum/skill/misc/tracking, SKILL_LEVEL_APPRENTICE, TRUE)	//Decent tracking akin to Skirmisher.
