...
/datum/outfit/job/roguetown/guardsman/archer/pre_equip(mob/living/carbon/human/H)
	...
	H.mind.adjust_skillrank(/datum/skill/combat/crossbows, SKILL_LEVEL_MASTER, TRUE)		//Why master? Because all it does is effect draw time, which is strength x skill / 1.2. (Bow is just skill / 1.0). You get poor bonus strength, so you get skill to offset.
	...
	H.mind.adjust_skillrank(/datum/skill/combat/shields, SKILL_LEVEL_NOVICE, TRUE)		//Maybe take away? Leaving for now just as a fall-back for non-lethal ability.
	...
	H.mind.adjust_skillrank(/datum/skill/misc/reading, SKILL_LEVEL_NOVICE, TRUE)
	H.mind.adjust_skillrank(/datum/skill/misc/medicine, SKILL_LEVEL_NOVICE, TRUE)
	H.mind.adjust_skillrank(/datum/skill/craft/crafting, SKILL_LEVEL_NOVICE, TRUE)	//For basic crafting; you'll need it due to relegated support role.
	H.mind.adjust_skillrank(/datum/skill/craft/tanning, SKILL_LEVEL_NOVICE, TRUE)	//Likely hunter background; very crappy basic skill.
	H.mind.adjust_skillrank(/datum/skill/misc/tracking, SKILL_LEVEL_NOVICE, TRUE) 
