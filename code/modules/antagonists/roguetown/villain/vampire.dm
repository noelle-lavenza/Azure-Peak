...
/datum/antagonist/vampire/on_gain()
	if(!is_lesser)
		owner.adjust_skillrank(/datum/skill/combat/wrestling, SKILL_LEVEL_LEGENDARY, TRUE)
		owner.adjust_skillrank(/datum/skill/combat/unarmed, SKILL_LEVEL_LEGENDARY, TRUE)
