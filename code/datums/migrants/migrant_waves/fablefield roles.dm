...
/datum/outfit/job/roguetown/fablefield/goliard/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		H.mind.adjust_skillrank(/datum/skill/misc/music, SKILL_LEVEL_LEGENDARY, TRUE)
		...
		H.mind.adjust_skillrank(/datum/skill/magic/holy, SKILL_LEVEL_APPRENTICE, TRUE) //Futureproofing, does nothing for now.
...
/datum/outfit/job/roguetown/fablefield/troubadour/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		H.mind.adjust_skillrank(/datum/skill/misc/music, SKILL_LEVEL_MASTER, TRUE)
		...
		H.mind.adjust_skillrank(/datum/skill/combat/wrestling, SKILL_LEVEL_APPRENTICE, TRUE)
		H.mind.adjust_skillrank(/datum/skill/combat/unarmed, SKILL_LEVEL_APPRENTICE, TRUE)
		H.mind.adjust_skillrank(/datum/skill/magic/holy, SKILL_LEVEL_NOVICE, TRUE) //Futureproofing, does nothing for now.
		H.mind.adjust_skillrank(/datum/skill/craft/crafting, SKILL_LEVEL_NOVICE, TRUE)
		H.mind.adjust_skillrank(/datum/skill/craft/cooking, SKILL_LEVEL_NOVICE, TRUE)
		H.change_stat("perception", 2)
