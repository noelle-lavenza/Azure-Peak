/datum/virtue/items/rich
	...
	added_skills = list(list(/datum/skill/misc/reading, 1, SKILL_LEVEL_LEGENDARY))	//So the spell would work
...
/datum/virtue/items/arsonist
	...
	added_skills = list(list(/datum/skill/craft/alchemy, 1, SKILL_LEVEL_LEGENDARY))
